...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("UniMed")),
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    onChanged: (String text) {
                      // if (debounce?.isActive ?? false) _debounce.cancel();
           ...
           child: StreamBuilder(
             ...
             builder: (BuildContext context, AsyncSnapshot snapshot) {
               if (snapshot.data == null) {
                 return Center(
                   child: Text("Please enter a term to search"),
                 );
               }
                     ...
                     return ListBody(
                       children: <Widget>[
                         ...
                         Padding(
                           ...
                           child: Text(snapshot.data["definitions"][index]["defintion"]),
                         )
                       ],
                     );
